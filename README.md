...
> **Status:** v0.2.4+ — the full loop works end-to-end and is validated against live networks
...
**Part of the freed-dev-llc agent family** — Argus is the open, shared network
source-of-truth tool used by the family's private AI assistants and sibling tools. It pairs
with **Mnemosyne**, the family's RAG knowledge brain, which *explains* the vendors Argus
...
- **Container images** — `ghcr.io/freed-dev-llc/argus-server` and
  `ghcr.io/freed-dev-llc/argus-web` (tags `0.2.4` and `latest`):

  ```bash
  docker pull ghcr.io/freed-dev-llc/argus-server:0.2.4
  docker pull ghcr.io/freed-dev-llc/argus-web:0.2.4
  ```
