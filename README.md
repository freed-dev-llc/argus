...
> **Status:** v0.2.8+ — the full loop works end-to-end and is validated against live networks
...
- **Container images** — `ghcr.io/freed-dev-llc/argus-server` and
  `ghcr.io/freed-dev-llc/argus-web` (tags `0.2.8` and `latest`):

  ```bash
  docker pull ghcr.io/freed-dev-llc/argus-server:0.2.8
  docker pull ghcr.io/freed-dev-llc/argus-web:0.2.8
  ```
