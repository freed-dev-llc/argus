...
- **Container images** — `ghcr.io/freed-dev-llc/argus-server` and
  `ghcr.io/freed-dev-llc/argus-web` (tags `0.2.2` and `latest`):

  ```bash
  docker pull ghcr.io/freed-dev-llc/argus-server:0.2.2
  docker pull ghcr.io/freed-dev-llc/argus-web:0.2.2
  ```
