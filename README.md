...
> **Status:** v0.2.1 — the full loop works end-to-end and is validated against a live UniFi
...
- **Container images** — `ghcr.io/freed-dev-llc/argus-server` and
  `ghcr.io/freed-dev-llc/argus-web` (tags `0.2.1` and `latest`):

  ```bash
  docker pull ghcr.io/freed-dev-llc/argus-server:0.2.1
  docker pull ghcr.io/freed-dev-llc/argus-web:0.2.1
  ```
